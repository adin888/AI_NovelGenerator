...
def build_left_layout(self):
    ...
    local_column = 0
    self.btn_generate_blueprint = ctk.CTkButton(
        self.step_buttons_frame,
        text="Step1. 生成系列",
        command=self.generate_series_blueprint_ui,
        font=("Microsoft YaHei", 12)
    )
    self.btn_generate_blueprint.grid(row=0, column=local_column, padx=5, pady=2, sticky="ew")
    ...
    self.btn_generate_architecture.grid(row=0, column=local_column, padx=5, pady=2, sticky="ew")
    ...
    self.btn_generate_directory.grid(row=0, column=local_column, padx=5, pady=2, sticky="ew")
    ...
    self.btn_generate_chapter.grid(row=0, column=local_column, padx=5, pady=2, sticky="ew")
    ...
    self.btn_finalize_chapter.grid(row=0, column=local_column, padx=5, pady=2, sticky="ew")
